            ...
            <button
                ...
                className={`px-4 py-2 rounded-xl border text-sm font-semibold transition-all duration-200 ${
                    currentPage === 1
                        ...
                        : 'bg-white dark:bg-gray-700 text-blue-600 dark:text-blue-400 border-blue-500 dark:border-blue-400 hover:bg-blue-50 dark:hover:bg-gray-600 cursor-pointer shadow-sm'
                }`}
            >
                Anterior
            </button>
