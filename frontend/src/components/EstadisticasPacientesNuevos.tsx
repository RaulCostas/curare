        ...
        <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl md:text-3xl font-extrabold text-gray-800 dark:text-white tracking-tight">Estadísticas de Pacientes Nuevos</h1>
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5 font-medium">Evolución de registros y captación de nuevos pacientes por mes</p>
                    </div>
                </div>
                <button
