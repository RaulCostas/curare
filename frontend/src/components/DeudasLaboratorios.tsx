...
const DeudasLaboratorios: React.FC = () => {
    ...
    const totalDeudasSum = filteredDeudas.reduce((sum, work) => sum + (Number(work.total) || 0), 0);
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5 font-medium">
                            Listado de trabajos de laboratorio concluidos pendientes de pago
                        </p>
                    </div>
                </div>
                <button
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead className="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            ...
                            <th className="px-6 py-3 text-center text-xs font-semibold text-gray-500 dark:text-gray-300 uppercase tracking-wider">Elemento Dental</th>
                            ...
                            <tr key={work.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td className="p-3">
                                    <button
                                        ...
                                        className="p-2 bg-green-600 hover:bg-green-700 text-white rounded-lg shadow-md transition-all transform hover:-translate-y-0.5 flex items-center gap-1 text-xs font-medium"
                                        title="Pagar"
                                    >
