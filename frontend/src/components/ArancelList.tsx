                    ...
                    <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        {aranceles.map((a, index) => (
                            <tr key={a.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td className="p-3 text-gray-700 dark:text-gray-300 font-semibold">{a.precio1}</td>
                                <td className="p-3 text-gray-700 dark:text-gray-300 font-semibold">{a.precio2}</td>
                                <td className="p-3 text-gray-700 dark:text-gray-300">{a.tc}</td>
                                <td className="p-3">
