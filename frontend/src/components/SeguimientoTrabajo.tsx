                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5 font-medium">
                            Control de prueba de cera, metal, bizcocho y entrega final
                        </p>
                    </div>
                </div>
                <button
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative">
                                ...
                                >
                                    <option value="Envio">Envío (Al Laboratorio)</option>
                        ...
                        <div className="flex gap-2 mt-2">
                            <button
                                type="submit"
                                className={`flex-1 font-bold py-2.5 px-4 rounded-xl shadow-md transition-all transform hover:-translate-y-0.5 active:scale-95 text-sm flex items-center justify-center gap-2 ${editingId
                            ...
                            {editingId && (
                                <button
                                    ...
                                    className="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2.5 px-4 rounded-xl shadow-md transition-all transform hover:-translate-y-0.5 active:scale-95 text-sm flex items-center justify-center gap-1"
                                >
                                ...
                                <div key={item.id} className="flex justify-between items-start p-4 rounded-lg bg-white dark:bg-gray-700/40 border border-gray-100 dark:border-gray-600 shadow-sm hover:shadow-md transition-shadow group">
                                    ...
                                    <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <button
                                            ...
                                            className="bg-yellow-400 hover:bg-yellow-500 text-white p-2 rounded-lg shadow-md transition-all transform hover:-translate-y-0.5 active:scale-95"
                                        ...
                                        <button
                                            ...
                                            className="bg-red-500 hover:bg-red-600 text-white p-2 rounded-lg shadow-md transition-all transform hover:-translate-y-0.5 active:scale-95"
                                            title="Eliminar registro"
                                        >
