...
const PresupuestoList: React.FC = () => {
    ...
    // User permissions for WhatsApp budget sending
    const [userPermisos, setUserPermisos] = useState<string[]>(() => {
        const userStored = localStorage.getItem('user');
        if (userStored) {
            try {
                const parsed = JSON.parse(userStored);
                return Array.isArray(parsed.permisos) ? parsed.permisos : [];
            } catch (e) {
                return [];
            }
        }
                ...
                try {
                    ...
                    if (parsedUser.id) {
                        ...
                        if (res.data) {
                            ...
                            setUserPermisos(Array.isArray(res.data.permisos) ? res.data.permisos : []);
                        }
                    }
                } catch (e) {
    ...
    const canSendWhatsApp = !userPermisos.includes('enviar-presupuesto-whatsapp');
            ...
            <div className="overflow-x-auto rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        {filteredProformas.length === 0 && (
                            <tr>
                                <td colSpan={canSendWhatsApp ? 11 : 10} className="px-5 py-10 text-center text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800">
