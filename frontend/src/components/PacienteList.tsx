                            ...
                            <tr key={paciente.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                ...
                                <td className="no-print p-3 flex gap-2">
                                    <button
                                        ...
                                        className="p-2 bg-indigo-500 hover:bg-indigo-600 text-white rounded-lg shadow-md transition-all transform hover:-translate-y-0.5"
                                        title="Ver Imágenes y Radiografías"
                                    >
