...
const PrecioLaboratorioList: React.FC = () => {
    ...
    // Modal state for PrecioLaboratorioForm
    ...
    const fetchPrecios = async () => {
        try {
            const response = await api.get(`/precios-laboratorios?page=${currentPage}&limit=${limit}&search=${searchTerm}`);
    ...
    const fetchPrintLaboratorios = async () => {
        try {
            // Fetch all prices to extract unique laboratories
            ...
            // Extract unique laboratories from prices
    ...
    const handleConfirmPrint = async () => {
        try {
            // Fetch records for printing with optional laboratory filter
            ...
            // Use hidden iframe for printing (avoid about:blank tab)
    ...
    const handleConfirmExport = async () => {
        try {
            ...
            // Generate PDF matching print format
            const doc = new jsPDF();
            ...
            // Laboratory subtitle box (if specific lab selected)
            if (labSubtitle) {
            ...
            // Adjust columns based on whether a specific lab is selected
            ...
            autoTable(doc, {
                ...
                columnStyles: isSpecificLabSelected ? {
                    0: { cellWidth: 'auto' },
                ...
                didParseCell: function (data) {
                    // Style estado column based on value
    ...
    return (
        <div className="content-card bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-8 transition-colors duration-300">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5 font-medium">
                            Tarifario y costos de trabajos dentales en laboratorios externos
                        </p>
                    </div>
                </div>
                ...
                <div className="relative flex-grow max-w-md flex items-center gap-2">
                    ...
                    {searchTerm && (
                        <button
                            ...
                            className="px-3 py-2 bg-gray-500 hover:bg-gray-600 text-white font-bold rounded-lg shadow-sm transition-all text-xs flex items-center gap-1 shrink-0 cursor-pointer"
                        >
                            <X size={14} />
                            <span>Limpiar</span>
                        </button>
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        {Array.isArray(precios) && precios.map((precio, index) => (
                            <tr key={precio.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                    ...
                    <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                        ...
                        <div className="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                            ...
                            <div className="bg-gray-50 dark:bg-gray-700/50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                <button
                                    type="button"
                                    className={`w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 ${modalMode === 'export' ? 'bg-red-600 hover:bg-red-700 focus:ring-red-500' : 'bg-blue-600 hover:bg-blue-700 focus:ring-blue-500'} text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm ${!selectedLabId ? 'opacity-50 cursor-not-allowed' : ''
                                        }`}
            ...
            {/* PrecioLaboratorioForm Modal */}
            <PrecioLaboratorioForm
                isOpen={isFormOpen}
