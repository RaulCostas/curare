...
const CalificacionList: React.FC = () => {
    ...
    // Modal state for CalificacionForm
    const [isFormOpen, setIsFormOpen] = useState(false);
    const [selectedCalificacionId, setSelectedCalificacionId] = useState<number | null>(null);
        ...
        <div className="content-card">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                <div className="flex items-center gap-3">
                    <div className="p-3 bg-yellow-100 dark:bg-yellow-900/50 text-yellow-600 dark:text-yellow-400 rounded-2xl shadow-sm">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5 font-medium">
                            Evaluación del desempeño, atención al cliente y calificaciones de pacientes
                        </p>
                    </div>
                </div>
                <div className="flex gap-2">
                    ...
                    >
                        <span className="text-xl">+</span> Nueva Calificación
                    </button>
                </div>
            </div>
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        {calificaciones.map((cal, index) => (
                            <tr key={cal.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
