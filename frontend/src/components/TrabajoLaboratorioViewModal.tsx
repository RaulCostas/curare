                ...
                <div class="info-section">
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <span class="value">${new Date(trabajo.fecha).toLocaleDateString()}</span>
                        </div>
                        <div class="info-item">
                        ...
                        <div class="info-item">
                            ...
                            <span class="value">${trabajo.fecha_pedido ? new Date(trabajo.fecha_pedido).toLocaleDateString() : '-'}</span>
                        </div>
                         <div class="info-item">
                            <span class="label">Fecha Terminado</span>
                            <span class="value">${trabajo.fecha_terminado ? new Date(trabajo.fecha_terminado).toLocaleDateString() : '-'}</span>
                        </div>
                        <div class="info-item">
        ...
        <div className="fixed inset-0 z-[9999] overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div className="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full border border-gray-200 dark:border-gray-700">
                                ...
                                {loading ? (
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div>
                                            ...
                                            {history.length === 0 ? (
                                                <p className="text-gray-500 dark:text-gray-400 italic text-sm text-center py-4 bg-gray-50 dark:bg-gray-700/30 rounded border border-dashed border-gray-200 dark:border-gray-600">No hay movimientos registrados.</p>
                                            ) : (
                                                <div className="flex flex-col gap-3">
                                                    {history.map((item) => (
                                                        <div key={item.id} className="flex gap-4 items-center p-3 rounded-lg bg-gray-50 dark:bg-gray-700/40 border border-gray-100 dark:border-gray-600">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-700/50 px-6 py-3 border-t border-gray-100 dark:border-gray-700 flex justify-start gap-3">
                        <button
                            type="button"
                            className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2.5 px-5 rounded-xl shadow-md transition-all transform hover:-translate-y-0.5 active:scale-95 text-sm flex items-center gap-2"
                            onClick={handlePrint}
                        >
