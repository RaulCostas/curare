...
const regex = /<fieldset className="border border-gray-300 dark:border-gray-700 p-4 rounded-lg mt-4">[\s\S]*?<\/textarea>\s*<\/div>/;

const replaceStr = `<fieldset className="border border-gray-300 dark:border-gray-700 p-4 rounded-lg mt-4 bg-gray-50 dark:bg-gray-800">
