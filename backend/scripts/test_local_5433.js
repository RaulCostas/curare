...
async function testLocal(password, database = 'curare') {
  ...
  try {
    ...
    console.log(`Connected to local on port 5433 with password "${password}" and db "${database}"!`);
...
async function main() {
  const passwords = ['postgrespg', 'postgres', 'boquenze654', 'admin', 'root', '123456', '1234'];
