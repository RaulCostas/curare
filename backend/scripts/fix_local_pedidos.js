...
async function fixLocal() {
  ...
  console.log('--- Corrigiendo base de datos LOCAL (127.0.0.1:5433) ---');
  ...
  console.log(`Se encontraron ${resMismatch.rows.length} pagos históricos desfasados con pedidos de 2026 en LOCAL.`);
  ...
  console.log('\n--- Verificando pedidos del proveedor 39 en LOCAL ---');
